    ...
    <div className="w-full mx-auto max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-5xl">
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-4 md:p-6 lg:p-8">
        ...
        <form onSubmit={onSubmit} className="space-y-2 sm:space-y-4 md:space-y-5 text-left">
          ...
          <div>
             <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1"> Name*</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 md:gap-5">
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">Email ID*</label>
              <input 
                value={values.email} 
            ...
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">Address*</label>
              <input 
            ...
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">City*</label>
              <input 
                value={values.city} 
            ...
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">Town*</label>
              <input 
                value={values.town} 
            ...
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">State*</label>
              <input 
                value={values.state} 
            ...
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">Postal code*</label>
              <input 
            ...
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">Country*</label>
              <CountrySelector
            ...
            <div className="sm:col-span-1">
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">Mobile No*</label>
...
/>
            ...
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">Password*</label>
              <div className="relative">
                <input 
            ...
            <div>
              <label className="block font-[Inter_Tight] font-normal text-[14px] leading-[100%]text-black mb-1">Confirm Password*</label>
              <div className="relative">
                <input 
